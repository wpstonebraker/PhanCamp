...
const FeatureIndex = (props) => {
  debugger;
  if (props.features.phish === undefined) return null;
  const { phish, theGD, goose, ween } = props.features;
  ...
  return (
    <div className="fi-container">
      <div className="fi-box">
        <div
          className="fi-main"
          onClick={() => props.history.push(`/artists/${phish.id}`)}
        >
        ...
        <div className="fi-side">
          <div
            ...
            onClick={() => props.history.push(`/artists/${ween.id}`)}
          >
            <img
          ...
          <div
            className="fis-item-container"
            onClick={() => props.history.push(`/artists/${theGD.id}`)}
          >
            <img
          ...
          <div
            className="fis-item-container"
            onClick={() => props.history.push(`/artists/${goose.id}`)}
          >
            <img
